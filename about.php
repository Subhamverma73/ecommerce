...
<section class="about">
   ...
   <div class="row">
      ...
      <div class="content">
         ...
         <p>Hey There ! I'm Subham Verma. A Student of B.TECH in Computer Science Engineering Department from indo global College [Batch : 2020] . I love designing websites and exploring new things. Learning new things is my hobby.</p>

         <p>I would like to thank <a href="https://www.facebook.com/er.ashokbasnet" target="_blank">Er. Subham Verma</a> Sir for guiding me through the session and making me able to develop projects like this. </p>
...
<section class="reviews">
   ...
   <div class="swiper-wrapper">
      ...
      <div class="swiper-slide slide">
         ...
         <p>Verma's is great if you choose good sellers . A variety of required item available . Customers can return and refund full amount within 7 days easily . KinBech is boosting eCommerce business in Kathmandu.It provides great opportunity to sale items online with ease.</p>
         <div class="stars">
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
      ...
      <div class="swiper-slide slide">
         ...
         <p>Using Verma's for online shopping from almost 3 years. Outstanding experience with them. Game vouchers and pick up point as delivery with 0 shipping charges are super saving services.</p>
         <div class="stars">
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
